...
- **[Starting the game](concepts/starting-the-game.md)** — the 1337–38 setup, the contenders, the Friday khuṭba problem, and what the opening fifteen years actually look like.
- **[The Erānzamīn situation](concepts/eranzamin-situation.md)** — the realm-wide succession crisis that frames every Iranian campaign in this period.

If you want to understand the systems:

- **[The Persianate Sultanate government](concepts/persianate-sultanate.md)** — the baseline government type and what it does differently from a European monarchy.
